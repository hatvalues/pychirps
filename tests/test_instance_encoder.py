...
def test_instance_encoder_cervical(cervicalb_pd):
    ...
    assert_dict_matches_fixture(instance_encoder.column_descriptors, "column_descriptors_cervicalb")
...
def test_instance_encoder_nursery(nursery_pd):
    ...
    assert_dict_matches_fixture(instance_encoder.column_descriptors, "column_descriptors_nursery")
